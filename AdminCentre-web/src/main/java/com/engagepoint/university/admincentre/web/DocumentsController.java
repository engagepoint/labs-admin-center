...
//        public void addNode(String name, String value, String type){
//            TreeNode treeNode = new DefaultTreeNode(new Document(name, value, type), selectedNode);
//        }
    
        
    public void addNode() {
        TreeNode newNode = new DefaultTreeNode(new Document("New Node", "-", "-"), selectedNode);
        
    }
    
    public void addRootNode() {
        TreeNode newNode = new DefaultTreeNode(new Document("New Node", "-", "-"), root);
